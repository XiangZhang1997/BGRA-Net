...
class BilinearUpsampling(Layer):
    ...
    def call(self, inputs):
        ...
        # .tf 2.                                     int(inputs.shape[2] * self.upsampling[1])))
...
def deeplabv3_plus(nClasses=1, input_height=224, input_width=224, out_stride=16,pretrained_weights=None):
    ...
    x = xception_downsample_block(x, 128)
    ...
    x = res_xception_downsample_block(x,728)
