...
def baseline(num_class=1,Pre =Efb7,Pre_list=efb7,pretrained_weights=None):
    ...
    pre_trained_b3 = UpSampling2D(size=2)(pre_trained_b3) #in14 out112 160
    ...
    #Decoder
    d_x6 = res_decoder(filters_list[3])((pre_trained_b5,pre_trained_b4)) #in7 14 out14 512
    d_x7 = res_decoder(filters_list[2])((d_x6,pre_trained_b3)) #in14 28 out28 256
    d_x8 = res_decoder(filters_list[1])((d_x7,pre_trained_b2)) #in28 56 out56 128
    d_x9 = res_decoder(filters_list[0])((d_x8,pre_trained_b1)) #in56 112 out112 64
...
#baseline + ASAF
def baseline_ASAF(num_class=1,Pre =Efb7,Pre_list=efb7,pretrained_weights=None):
...
'''
#baseline + BRM_BAM
def baseline_BRM_BAM(num_class=1,Pre =Efb7,Pre_list=efb7,pretrained_weights=None):

    inp = Input(input_size)
    #Encoder
    pre_trained_b1 = encoder(Pre)((Pre_list[0])) #56 48
    pre_trained_b1 = UpSampling2D(size=2)(pre_trained_b1) #in56 out112 48
    bd1 = side_branch(2)(pre_trained_b1)
    bd1 = Conv2D(1, 1, activation = 'sigmoid',name='bd1')(bd1) #224 1

    pre_trained_b2 = encoder(Pre)((Pre_list[1])) #28 80
    pre_trained_b2 = UpSampling2D(size=2)(pre_trained_b2) #in28 out56 80
    bd2 = side_branch(4)(pre_trained_b2)
    bd2 = Conv2D(1, 1, activation = 'sigmoid',name='bd2')(bd2) #224 1

    pre_trained_b3 = encoder(Pre)((Pre_list[2])) #14 160
    pre_trained_b3 = UpSampling2D(size=2)(pre_trained_b3) #in14 out112 160
    bd3 = side_branch(8)(pre_trained_b3)
    bd3 = Conv2D(1, 1, activation = 'sigmoid',name='bd3')(bd3)#224 1

    pre_trained_b4 = encoder(Pre)((Pre_list[3])) #7 384
    pre_trained_b4 = UpSampling2D(size=2)(pre_trained_b4) #in7 out14 384
    bd4 = side_branch(16)(pre_trained_b4)
    bd4 = Conv2D(1, 1, activation = 'sigmoid',name='bd4')(bd4) #224 1

    pre_trained_b5 = encoder(Pre)((Pre_list[4])) #14 512 
    bd5 = side_branch(32)(pre_trained_b5) #add at 2021.5.31 10:36
    ...
    bd_fuse45_maxpooling = MaxPool2D((16,16))(bd_fuse45) #56 1
    ...
    bd_fuse345_maxpooling = MaxPool2D((8,8))(bd_fuse345) #56 1
    ...
    bd_fuse2345_maxpooling = MaxPool2D((4,4))(bd_fuse2345) #112 1
...
#     d_x8_add = ReLU()(d_x8_add)
    ...
    #strong_d_x9
    d_x9_multiply = multiply([d_x9,bd_fuse12345_maxpooling])
...
#baseline + RRM
def baseline_RRM(num_class=1,Pre =Efb7,Pre_list=efb7,pretrained_weights=None):
...
def baseline_ASAF_BRM_BAM(num_class=1,Pre =Efb7,Pre_list=efb7,pretrained_weights=None):
    ...
    mid = mid_v1(filters_list[4],3,dilation_list=[1,3,5])(pre_trained_b5) #7 1024
    mid_mask1 = side_branch(32)(mid)
    mid_mask1 = Conv2D(1, 1, activation = 'sigmoid',name='mid_mask1')(mid_mask1)
    #Decoder
    d_x6 = res_decoder(filters_list[3])((pre_trained_b5,pre_trained_b4)) #in14 14 out28 512
#     strong_d_x6 
...
#baseline + ASAF + RRM
def baseline_ASAF_RRM(num_class=1,Pre =Efb7,Pre_list=efb7,pretrained_weights=None):

    inp = Input(input_size)
    #Encoder
    pre_trained_b1 = encoder(Pre)((Pre_list[0])) #56 48 ????????tuple
    pre_trained_b1 = UpSampling2D(size=2)(pre_trained_b1) #in56 out112 48
...
def baseline_BRM_BAM_RRM(num_class=1,Pre =Efb7,Pre_list=efb7,pretrained_weights=None):
    ...
    pre_trained_b4 = encoder(Pre)((Pre_list[3])) #7 384
    pre_trained_b4 = UpSampling2D(size=2)(pre_trained_b4) #in7 out14 384
    print(pre_trained_b4.shape)
    bd4 = side_branch(16)(pre_trained_b4)
    print(bd4.shape)
    bd4 = Conv2D(1, 1, activation = 'sigmoid',name='bd4')(bd4) #224 1

    pre_trained_b5 = encoder(Pre)((Pre_list[4])) #7 640
    bd5 = side_branch(32)(pre_trained_b5)
    bd5 = Conv2D(1, 1, activation = 'sigmoid',name='bd5')(bd5) #224 1
...
#     mid = mid_v1(filters_list[4],3,dilation_list=[1,3,5])(pre_trained_b5) #7 1024
    ...
    #Decoder
    d_x6 = res_decoder(filters_list[3])((pre_trained_b5,pre_trained_b4)) #in7 out14 512
    #strong_d_x6
    d_x6_multiply = multiply([d_x6,bd_fuse45_maxpooling]) #14 * 14
#     d_x6_add = add([d_x6_multiply,d_x6])
#     d_x6_add = ReLU()(d_x6_add)
    #mask_side1
    d_x6_mask2 = side_branch(16)(d_x6)
    ...
    #strong_d_x7
    d_x7_multiply = multiply([d_x7,bd_fuse345_maxpooling]) #28 * 28
#     d_x7_add = add([d_x7_multiply,d_x7])
#     d_x7_add = ReLU()(d_x7_add)
    #mask_side2
    d_x7_mask3 = side_branch(8)(d_x7)
    ...
    #strong_d_x8
    d_x8_multiply = multiply([d_x8,bd_fuse2345_maxpooling]) #56 * 56
#     d_x8_add = add([d_x8_multiply,d_x8])
#     d_x8_add = ReLU()(d_x8_add)
    #mask_side3
    d_x8_mask4 = side_branch(4)(d_x8)
    ...
    #strong_d_x9
    d_x9_multiply = multiply([d_x9,bd_fuse12345_maxpooling]) #112 * 112
#     d_x9_add = add([d_x9_multiply,d_x9])
#     d_x9_add = ReLU()(d_x9_add)
    #mask_side4
    d_x9_mask5 = side_branch(2)(d_x9)
...
def baseline_ASAF_BRM_BAM_RRM(num_class=1,Pre =Efb7,Pre_list=efb7,pretrained_weights=None):
#     Pre.summary()
    inp = Input(input_size)
    #Encoder
    pre_trained_b1 = encoder(Pre)((Pre_list[0])) #56 48 ????????tuple
...
#vgg16_res_decoder
def vgg16_res_decoder(num_class=1,Pre =VGG16,Pre_list=vgg16,pretrained_weights=None):
...
#vgg16_decoder
def efb7_decoder(num_class=1,Pre =Efb7,Pre_list=efb7,pretrained_weights=None):

#     Pre.summary()
    inp = Input(input_size)
    #Encoder
    pre_trained_b1 = encoder(Pre)((Pre_list[0])) #56 48 ????????tuple S2
    pre_trained_b1 = UpSampling2D(size=2)(pre_trained_b1) #in56 out112 48
    bd1 = side_branch(2)(pre_trained_b1)
    bd1 = Conv2D(1, 1, activation = 'sigmoid',name='bd1')(bd1) #224 1

    pre_trained_b2 = encoder(Pre)((Pre_list[1])) #28 80 S3
    pre_trained_b2 = UpSampling2D(size=2)(pre_trained_b2) #in28 out56 80
    bd2 = side_branch(4)(pre_trained_b2)
    bd2 = Conv2D(1, 1, activation = 'sigmoid',name='bd2')(bd2) #224 1

    pre_trained_b3 = encoder(Pre)((Pre_list[2])) #14 160 S4
    pre_trained_b3 = UpSampling2D(size=2)(pre_trained_b3) #in14 out28 160
    bd3 = side_branch(8)(pre_trained_b3)
    bd3 = Conv2D(1, 1, activation = 'sigmoid',name='bd3')(bd3)#224 1

    pre_trained_b4 = encoder(Pre)((Pre_list[3])) #7 384 S6
    pre_trained_b4 = UpSampling2D(size=2)(pre_trained_b4) #in7 out14 384
#     print(pre_trained_b4.shape)
    bd4 = side_branch(16)(pre_trained_b4)
#     print(bd4.shape)
    ...
    pre_trained_b5 = encoder(Pre)((Pre_list[4])) #7 640 S7
    bd5 = side_branch(32)(pre_trained_b5)
    bd5 = Conv2D(1, 1, activation = 'sigmoid',name='bd5')(bd5) #224 1
    ...
    #Decoder
    d_x6 = unet_decoder(filters_list[3])((mid,pre_trained_b4)) #in7 out14 512
    #strong_d_x6
    d_x6_multiply = multiply([d_x6,bd_fuse45_maxpooling]) #14 * 14
#     d_x6_add = add([d_x6_multiply,d_x6])
#     d_x6_add = ReLU()(d_x6_add)
    ...
    d_x7 = unet_decoder(filters_list[2])((d_x6_multiply,pre_trained_b3)) #in14 out28 256
    #strong_d_x7
    d_x7_multiply = multiply([d_x7,bd_fuse345_maxpooling]) #28 * 28
#     d_x7_add = add([d_x7_multiply,d_x7])
#     d_x7_add = ReLU()(d_x7_add)
    ...
    d_x8 = unet_decoder(filters_list[1])((d_x7_multiply,pre_trained_b2)) #in28 out56 128
    #strong_d_x8
    d_x8_multiply = multiply([d_x8,bd_fuse2345_maxpooling]) #56 * 56
#     d_x8_add = add([d_x8_multiply,d_x8])
#     d_x8_add = ReLU()(d_x8_add)
    ...
    d_x9 = unet_decoder(filters_list[0])((d_x8_multiply,pre_trained_b1)) #in56 out112 64
    #strong_d_x9
    d_x9_multiply = multiply([d_x9,bd_fuse12345_maxpooling]) #112 * 112
#     d_x9_add = add([d_x9_multiply,d_x9])
#     d_x9_add = ReLU()(d_x9_add)
...
# Res50_res_decoder
def Res50_res_decoder(num_class=1,Pre =Res50,Pre_list=res50,pretrained_weights=None):
    Pre.summary()
    inp = Input(input_size)
    #Encoder
    pre_trained_b1 = encoder(Pre)((Pre_list[0])) #112 64
    bd1 = side_branch(2)(pre_trained_b1)
    bd1 = Conv2D(1, 1, activation = 'sigmoid',name='bd1')(bd1) #224 1

    pre_trained_b2 = encoder(Pre)((Pre_list[1])) #56 256
    bd2 = side_branch(4)(pre_trained_b2)
    bd2 = Conv2D(1, 1, activation = 'sigmoid',name='bd2')(bd2) #224 1

    pre_trained_b3 = encoder(Pre)((Pre_list[2])) #28 512
    bd3 = side_branch(8)(pre_trained_b3)
    bd3 = Conv2D(1, 1, activation = 'sigmoid',name='bd3')(bd3)#224 1

    pre_trained_b4 = encoder(Pre)((Pre_list[3])) #14 1024
    bd4 = side_branch(16)(pre_trained_b4)
    bd4 = Conv2D(1, 1, activation = 'sigmoid',name='bd4')(bd4) #224 1

    pre_trained_b5 = encoder(Pre)((Pre_list[4])) #7 2048
    bd5 = side_branch(32)(pre_trained_b5)
    bd5 = Conv2D(1, 1, activation = 'sigmoid',name='bd5')(bd5) #224 1
